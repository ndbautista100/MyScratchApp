...
public class PostActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_post_activity, container, false);
        ...
        addpostimage = view.findViewById(R.id.Postaddimage);
        ...
        submitbutton = view.findViewById(R.id.postsubmitbutton);
            ...
            if(imageLocationUri != null) {
                ...
                uploadTask.continueWithTask(task -> {
                    ...
                    if(task.isSuccessful()) {
                        ...
                        db.collection("posts")
                                .document(posts.getDocumentID())
                                .update("image_URL", posts.getImageURL(),
                                        "imageName", imageName)
                                .addOnCompleteListener(task1 -> {
                                    loadingDialog.dismissDialog();
                                    Toast.makeText(getActivity(), "Post image uploaded!", Toast.LENGTH_SHORT).show();
                                })
    ...
    private void addDatatoFirebase(){
        posts = new Posts(status.getText().toString(), userID);

        postref.add(posts).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            @Override
